...
async def lifespan(app: FastAPI):
    ...
    global answer_task
    answer_task = pipeline("sentiment-analysis", model="cardiffnlp/twitter-roberta-base-sentiment-latest", tokenizer="cardiffnlp/twitter-roberta-base-sentiment-latest")
    yield
...
async def classify_text(text_input:TextInput):
    ...
    try:
        ...
        return answer_task(preprocess_text(text_input.text))
